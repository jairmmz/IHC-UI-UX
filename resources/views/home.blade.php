		...
		<div class="row align-items-center">
			<div class="col-lg-7">
				<div class="intro-wrap">
					<h1 class="mb-5"><span class="d-block">Disfrutemos de su</span> Viaje en <span class="typed-words"></span></h1>
		...
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-lg-6">
				<figure class="img-play-video">
					<a id="play-video" class="video-play-button" href="https://www.youtube.com/embed/Rb6Scz-5YOs" data-fancybox>
						<span></span>
					</a>
			...
			<div class="col-lg-5">
				<h2 class="section-title text-left mb-4">Eche un vistazo al video del recorrido</h2>
				<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
